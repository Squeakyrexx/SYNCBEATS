      ...
      {!isLoading && user && (
        <div className="flex flex-col items-center space-y-8 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-md">
            Ready to sync some beats? Create a new group or join an existing one.
          </p>
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6 w-full max-w-xs sm:max-w-sm pt-6">
